...
public class SpendingSummaryProcessor {
	...
	public List<StoreSpendingSummaryDTO> fetchTransactionDataForMonth(Object[] obj) throws URISyntaxException {
		...
		return processSpendingByCategory((String)obj[2], transactions);
	}
	...
	private List<StoreSpendingSummaryDTO> processSpendingByCategory(String category, List<TransactionDTO> transactions) {
