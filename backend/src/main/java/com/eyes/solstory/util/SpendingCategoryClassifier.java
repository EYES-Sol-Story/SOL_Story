...
public class SpendingCategoryClassifier {
    ...
    static {
        ...
        keywordToCategoryMap.put("투썸", "카페/디저트");
        keywordToCategoryMap.put("스타벅스", "카페/디저트");
        keywordToCategoryMap.put("커피", "카페/디저트");
        keywordToCategoryMap.put("디저트", "카페/디저트");
        keywordToCategoryMap.put("설빙", "카페/디저트");
        ...
        keywordToCategoryMap.put("쿠팡", "쇼핑");
        ...
        // OTT
        keywordToCategoryMap.put("구독", "OTT");
        keywordToCategoryMap.put("유튜브", "OTT");
        keywordToCategoryMap.put("아프리카TV", "OTT");
        keywordToCategoryMap.put("치지직", "OTT");
        keywordToCategoryMap.put("넷플릭스", "OTT");
        keywordToCategoryMap.put("디즈니플러스", "OTT");
        keywordToCategoryMap.put("티빙", "OTT");
        keywordToCategoryMap.put("왓챠", "OTT");
        keywordToCategoryMap.put("웨이브", "OTT");
