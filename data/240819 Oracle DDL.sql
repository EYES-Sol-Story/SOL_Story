...
DROP TABLE "daily_financial_summary";
...
CREATE TABLE "daily_financial_summary" (
	...
	"financial_type" NUMBER(5) NOT NULL,
...
COMMENT ON COLUMN "daily_financial_summary"."summary_date" IS '산출 날짜';
